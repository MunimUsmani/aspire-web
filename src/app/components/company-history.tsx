          ...
          <div className="flex flex-col md:flex-row gap-8 py-12 md:py-16 border-b border-gray-200">
            ...
            <div className="md:w-2/3">
              ...
              <p className="text-gray-700 mb-6 text-lg">
                ...
                professionals who demonstrate tremendous effort, integrity, and expertise. With over 4 years of combined
                experience in the HR domain, we have successfully collaborated with leading IT companies such as{" "}
                <span className="font-semibold text-[#0055b8]">MoxEdge</span>,{" "}
                <span className="font-semibold text-[#0055b8]">360 Marketing Mentor</span>,{" "}
                <span className="font-semibold text-[#0055b8]">TechFlex</span>,{" "}
                <span className="font-semibold text-[#0055b8]">Growth Mind Technologies</span>,{" "}
                <span className="font-semibold text-[#0055b8]">EZY Business Applications</span>,{" "}
                <span className="font-semibold text-[#0055b8]">TechXon</span>,{" "}
                <span className="font-semibold text-[#0055b8]">Pals Innovations</span>,{" "}
                <span className="font-semibold text-[#0055b8]">Ammani Traders</span>, and{" "}
          ...
          <div className="flex flex-col md:flex-row-reverse gap-8 py-12 md:py-16 border-b border-gray-200">
            ...
            <div className="md:w-2/3">
              ...
              <p className="text-gray-700 mb-6 text-lg">
                ...
                growth through strategic HR practices. We envision a future where businesses of all sizes have access to
                the talent they need to thrive in an increasingly competitive landscape, and where professionals can
                find roles that truly align with their skills, values, and career aspirations.
              </p>
              <p className="text-gray-700 mb-6 text-lg">
          ...
          <div className="flex flex-col md:flex-row gap-8 py-12 md:py-16">
            ...
            <div className="md:w-2/3">
              ...
              <p className="text-gray-700 mb-6 text-lg">
                ...
                employee satisfaction. We are committed to understanding the unique needs of each client and candidate,
                providing personalized solutions that create lasting value for all stakeholders.
              </p>
              <p className="text-gray-700 mb-6 text-lg">
